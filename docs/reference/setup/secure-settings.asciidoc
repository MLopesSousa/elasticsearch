...
[source,sh]
----------------------------------------------------------------
bin/elasticsearch-keystore add the.setting.name
----------------------------------------------------------------
...
[source,sh]
----------------------------------------------------------------
cat /file/containing/setting/value | bin/elasticsearch-keystore add --stdin the.setting.name
----------------------------------------------------------------
...
[source,sh]
----------------------------------------------------------------
bin/elasticsearch-keystore remove the.setting.name
----------------------------------------------------------------
